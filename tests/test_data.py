...
def create_altinn_test_catalog() -> Catalog:
    ...
    altinn_test_catalog.publisher = "https://organization-catalogue.fellesdatakatalog.digdir.no/organizations/991825827"

    model_publisher = Agent()
    model_publisher.identifier = "https://organization-catalogue.fellesdatakatalog.digdir.no/organizations/974761076"
    ...
    model_0.identifier = "http://altinn-model-publisher:8080/models/3314-1212-245-10980"
    model_0.title = {"nb": "Sensitive role Reporting"}

    model_1 = InformationModel()
    model_1.identifier = (
        "http://altinn-model-publisher:8080/models/3357-130429-4166-35895"
    )
    ...
    model_2.identifier = (
        "http://altinn-model-publisher:8080/models/3736-170607-4685-1706091129"
    )
    model_2.title = {
    ...
    model_3.identifier = (
        "http://altinn-model-publisher:8080/models/3743-140516-4444-32407"
    )
    model_3.title = {
    ...
    model_4.identifier = (
        "http://altinn-model-publisher:8080/models/3814-140602-4445-32408"
    )
    model_4.title = {
    ...
    model_5.identifier = (
        "http://altinn-model-publisher:8080/models/3906-141205-3940-20161021"
    )
...
<https://www.altinn.no/models/catalog> a dcat:Catalog ;
    ...
    ns1:model <http://altinn-model-publisher:8080/models/3314-1212-245-10980>,
        <http://altinn-model-publisher:8080/models/3357-130429-4166-35895>,
        <http://altinn-model-publisher:8080/models/3736-170607-4685-1706091129>,
        <http://altinn-model-publisher:8080/models/3743-140516-4444-32407>,
        <http://altinn-model-publisher:8080/models/3814-140602-4445-32408>,
...
<http://altinn-model-publisher:8080/models/3314-1212-245-10980> a dcat:Resource ;
    dct:title "Sensitive role Reporting"@nb .

<http://altinn-model-publisher:8080/models/3357-130429-4166-35895> a dcat:Resource ;
    dct:publisher <https://organization-catalogue.fellesdatakatalog.digdir.no/organizations/974761076> ;
    dct:title "A02 a-melding submission from system"@nb .

<http://altinn-model-publisher:8080/models/3736-170607-4685-1706091129> a dcat:Resource ;
    dct:publisher <https://organization-catalogue.fellesdatakatalog.digdir.no/organizations/974761076> ;
    dct:title "A06 a-melding version 3.1.0 order reconciliation information"@nb .

<http://altinn-model-publisher:8080/models/3743-140516-4444-32407> a dcat:Resource ;
    dct:publisher <https://organization-catalogue.fellesdatakatalog.digdir.no/organizations/974761076> ;
    dct:title "A04 Declaration of paid work at home where a private individual is the employer"@nb .

<http://altinn-model-publisher:8080/models/3814-140602-4445-32408> a dcat:Resource ;
    dct:publisher <https://organization-catalogue.fellesdatakatalog.digdir.no/organizations/974761076> ;
    dct:title "A05 Simplified a-melding for charitable and non-profit organisations"@nb .

<http://altinn-model-publisher:8080/models/3906-141205-3940-20161021> a dcat:Resource ;
    dct:publisher <https://organization-catalogue.fellesdatakatalog.digdir.no/organizations/974761076> ;
    dct:title "A01 a-melding"@nb .

<https://organization-catalogue.fellesdatakatalog.digdir.no/organizations/974761076> a foaf:Agent ;
